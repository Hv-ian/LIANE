    ...
    <>
      ...
      <nav className="nav">
        ...
        <div className="nav-icons">
          ...
          <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#1c1c1a" strokeWidth="1.5" style={{ cursor: 'pointer' }} onClick={() => onNavigate('loyalty')} title="Loyalty Circle"><circle cx="12" cy="8" r="4"></circle><path d="M4 21c0-4 3.6-6.5 8-6.5s8 2.5 8 6.5"></path></svg>
